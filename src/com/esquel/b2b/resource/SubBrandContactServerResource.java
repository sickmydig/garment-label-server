...
import com.esquel.b2b.schema.SubBrandContact;
import com.j256.ormlite.support.ConnectionSource;
import com.joyaether.datastore.resource.DataObjectServerResource;

public class SubBrandContactServerResource extends DataObjectServerResource<SubBrandContact, Long> {
	...
	@Override
	protected Class<SubBrandContact> getResourceType() {
		return SubBrandContact.class;
	}

	@Override
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(SubBrandContact.SUB_BRAND_CONTACT_ID_FIELD_NAME);
