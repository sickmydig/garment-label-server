...
public class CustomerServerResource extends ReadonlyDataObjectServerResource<Customer, Long> {
	...
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(Customer.CUSTOMER_ID_FIELD_NAME);
