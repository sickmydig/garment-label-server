...
import com.esquel.b2b.schema.Sale;
import com.j256.ormlite.support.ConnectionSource;
import com.joyaether.datastore.resource.ReadonlyDataObjectServerResource;

public class SaleServerResource extends ReadonlyDataObjectServerResource<Sale, Long> {
	...
	@Override
	protected Class<Sale> getResourceType() {
		return Sale.class;
	}

	@Override
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(Sale.SALES_ID_FIELD_NAME);
