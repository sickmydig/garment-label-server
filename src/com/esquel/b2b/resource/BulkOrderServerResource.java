...
import com.esquel.b2b.schema.BulkOrder;
import com.j256.ormlite.support.ConnectionSource;
import com.joyaether.datastore.resource.ReadonlyDataObjectServerResource;

public class BulkOrderServerResource extends ReadonlyDataObjectServerResource<BulkOrder, Long> {
	...
	@Override
	protected Class<BulkOrder> getResourceType() {
		return BulkOrder.class;
	}

	@Override
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(BulkOrder.BULK_ORDER_ID_FIELD_NAME);
