...
import com.esquel.b2b.schema.UnitDetail;
import com.j256.ormlite.support.ConnectionSource;
import com.joyaether.datastore.resource.ReadonlyDataObjectServerResource;

public class UnitDetailServerResource extends ReadonlyDataObjectServerResource<UnitDetail, Long> {
	...
	@Override
	protected Class<UnitDetail> getResourceType() {
		return UnitDetail.class;
	}

	@Override
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(UnitDetail.UNIT_DETAIL_ID_FIELD_NAME);
