...
@DatabaseTable(tableName = "message_types")
public class MessageType extends Model<MessageType, String> implements Identity<String> {
	
	public static final String ID_FIELD_NAME = "message_type_id";	
