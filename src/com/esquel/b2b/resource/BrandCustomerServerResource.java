...
public class BrandCustomerServerResource extends DataObjectServerResource<BrandCustomer, Long> {
	...
	protected Long getId() {
		String id = (String) getRequest().getAttributes().get(BrandCustomer.BRAND_CUSTOMER_ID_FIELD_NAME);
